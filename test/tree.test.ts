...
test("traversal keeps things in sorted order", () => {
...
test("update replaces existing values", () => {
    var tree: AVLNode<number, number> | null = null;
...
describe("treeUpdateByMapping", () => {
    test("updates values at specific times", () => {
        var tree: AVLNode<number, number> | null = null;
    ...
    test("with no matching time returns original tree", () => {
        var tree: AVLNode<number, number> | null = null;
...
describe("remove", () => {
    test("removes matching times from tree", () => {
        var tree: AVLNode<number, number> | null = null;
